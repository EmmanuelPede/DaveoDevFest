  ...
  <div class="player-details">
    <div class="d-flex flex-column justify-content-center" v-if="this.customer">
      <div class="d-flex flex-row">
        <h4 class="col pt-4 pb-4 mb-4 text-center heading">
          {{ this.customer.name }}
        </h4>
      </div>
      ...
      <div class="d-flex flex-column group">
        ...
        <span class="col">
          <span v-if="this.customer.lastScore">{{
            this.customer.lastScore.toLocaleString("fr-FR")
          }}</span>
          <span v-else>0</span>
          pt(s)
        </span>
      ...
      <div class="d-flex flex-column group">
        ...
        <span class="col">
          <span v-if="this.customer.bestScore">{{
            this.customer.bestScore.toLocaleString("fr-FR")
          }}</span>
          <span v-else>0</span>
          pt(s)
        </span>
